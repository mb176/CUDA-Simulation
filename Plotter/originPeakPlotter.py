...
for picIdx in range(1,nPictures):
    ...
    pOrigin =data[1,0:-1];
    pPeak = data[2,0:-1];
    fig = plt.figure(figsize=(10/np.sqrt(2),8))

    #style
    fontsize = 20; # for vertical lines
    ...
    plt.ylabel('Probability density at the origin', fontsize = fontsize)
    plt.gcf().subplots_adjust(left=0.15)
    plt.plot(time,pOrigin,'bo',label='Data')
